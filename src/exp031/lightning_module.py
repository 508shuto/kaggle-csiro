...
class CSIROModule(L.LightningModule):
    def __init__(
        ...
        self.model = CSIROModel(
            ...
            # MHA fusion settings
            use_mha_fusion=config.model.get("use_mha_fusion", False),
            mha_dim=config.model.get("mha_dim", 256),
            mha_heads=config.model.get("mha_heads", 4),
            mha_dropout=config.model.get("mha_dropout", 0.1),
        )
